...
- A recovered, uncommitted second batch adds 15 more matched images locally.
- There are 30 matched illustrations: ten Easy, ten Mixed, and ten Hard.
...
- `deer-sweater-freezer.webp` — “The nervous deer chose a purple sweater because the freezer felt better.” Show the deer enjoying the cold beside an open freezer while wearing the purple sweater.
...
- `wizard-theater-fern.webp` — “A thirsty wizard searched every theater, hunting a missing fern.” Show the wizard searching a theater, with the fern visible in the scene.
...
- `teacher-cake-fire-extinguisher.webp` — “A teacher carried a fiery cake onto the porch; the candles ordered a fire extinguisher.” Show the expressive candles gesturing toward a visible extinguisher.
- `mermaid-square-hat-reporter.webp` — “A mermaid wore a square hat on the pier; a fashion reporter called it perfect.” Make the square hat, reporter, microphone, and camera readable.
...
- `girl-pearls-cereal.webp` — “The girl tried to twirl thirty pearls before breakfast; the cereal declared itself the winner.” Clearly show the girl, many twirling pearls, and winning cereal as the visual payoff.
...
- `squirrel-fork-corn.webp` — “The squirrel twirled a fork while stirring corn; the server ducked.” Clearly show the squirrel, twirling fork, corn, and ducking server in one compact scene.
...
- `squirrel-purple-jar-resort.webp` — “The squirrel curled up inside a purple jar and called it a resort.” Make the transparent purple jar look like a tiny vacation resort.
- `girl-popcorn-squirrel-pearls.webp` — “The girl hurled popcorn at a squirrel wearing pearls; it asked for more.” Keep the toss playful and show the squirrel's pearls and bowl clearly.
...
7. Verify that Pictures Only shows the correct matching image and that each
   difficulty has the expected number of illustrated sentences.
